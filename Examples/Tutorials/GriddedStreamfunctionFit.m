...
if exist("tutorialFigureCapture", "var") && isa(tutorialFigureCapture, "function_handle"), tutorialFigureCapture("fixed-and-centered-drifters", Caption="In the fixed frame the Site 1 cluster translates together, while the center-of-mass frame removes that drift and reveals the coherent relative motion used by the mesoscale fit."); end
